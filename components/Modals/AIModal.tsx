        ...
        <div className="p-6 space-y-6">
          ...
          {contextNote && (
            <div className="p-4 bg-zinc-900 border border-zinc-800 rounded-xl">
              <p className="text-[11px] text-zinc-300 leading-relaxed">{contextNote}</p>
            </div>
          )}

          <div className="space-y-3">
            <label className="text-[10px] font-semibold text-zinc-500">Suggestions</label>
          ...
          <div className="p-4 bg-blue-600/5 border border-blue-500/20 rounded-xl flex gap-3 items-start">
            ...
            <p className="text-[11px] text-blue-200/60 leading-relaxed">
              Real AI generation requires a Google AI key for billing and safety. For quick testing, you can use neural simulation mode.
            </p>
          </div>
        </div>
